...
## 🌐 Download this App on your device using this link
...
1. User searches a city or uses geolocation  
2. Coordinates are fetched using Geocoding APIs  
3. Weather + AQI data is retrieved from APIs  
4. Data is processed and rendered dynamically  
5. Charts are drawn using Canvas API  
6. Smart insights are generated using custom logic  
